...
public class Blinky extends Ghost {
    public Blinky() {
        ...
        rightSprite.setAnimation(new Animation(graphics, 0, 6, 12 * 3, 12 * 3, 12 * 3 * 2, 12 * 3));
        leftSprite.setAnimation(new Animation(graphics, 4, 6, 12 * 3, 12 * 3, 12 * 3 * 2, 12 * 3));
        upSprite.setAnimation(new Animation(graphics, 6, 6, 12 * 3, 12 * 3, 12 * 3 * 2, 12 * 3));
        downSprite.setAnimation(new Animation(graphics, 2, 6, 12 * 3, 12 * 3, 12 * 3 * 2, 12 * 3));
